...
def config_parser():
    ...
    parser.add_argument('--config', is_config_file=True, default='/home/qiqi/APR/NeRF-Pose/script/config_nerfh.txt',
    ...
    parser.add_argument("--render_video_train", action='store_true',
    ...
    parser.add_argument("--no_DNeRF_viewdir", action='store_true', default=False,
    ...
    parser.add_argument("--lrate_decay", type=float, default=250,
    ...
    parser.add_argument("--NeRFH", action='store_true',
    ...
    parser.add_argument("--encode_hist", default=False, action='store_true',
    ...
    # dataset options
    parser.add_argument("--dataset_type", type=str, default='7Scenes', help='options: llff / 7Scenes')
