...
from dataset_loaders.load_7Scenes1 import load_7Scenes_dataloader
...
if len(sys.argv) == 1:
    config_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'config_direct_pn.txt')
    sys.argv.extend(['--config', config_path])

# Parse arguments after ensuring config file is specified
